        ...
        if subj~=subj_template
            ...
            for sit=1:num_iters_within_updates
                ...
                if sit==1 && uit==1
                    ...
                    num_nodes_to_change=randperm(max_num_nodes_to_change,1);%生成包含大小1：n的n个元素的随机排列        
                end;
                nodeinds=randperm(num_nodes,num_nodes_to_change); %生成num_nodes_to_change个1：num_nodes的整数的随机排列           
